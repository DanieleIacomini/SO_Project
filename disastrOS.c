...
void disastrOS_start(void (*f)(void*), void* f_args, char* logfile){
  ...
  syscall_numarg[DSOS_CALL_SEMOPEN]      = 2;   //GLI ARGOMENTI DELLA SEM_OPEN SONO DUE.
  ...
  syscall_numarg[DSOS_CALL_SEMPOST]      = 1;   //LA POST VUOLE UN SOLO ARGOMENTO.
...
//Inizializziamo le nostre quattro funzioni, ognuna di esse chiamiamo la syscall corrispondente dal Vettore
